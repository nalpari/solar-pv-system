...
const translations = {
  ...
  batterySelfConsumptionNote: {
    ja: "※発電シミュレーションの自家消費率は、蓄電池なしの場合は30％、蓄電池ありの場合は60％に設定します。",
    en: "※The self-consumption rate in the generation simulation is set to 30% without a battery and 60% with a battery.",
  },
